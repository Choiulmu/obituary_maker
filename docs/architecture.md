...
| M | 조의금계좌 | account | X | `국민 123456-01-123456 홍철수` |
| N | 추가안내문구 | message | X | `조화는 정중히 사양합니다` |
| O | 부고장링크 | shareUrl | O | `https://obituary.example.com/a1b2c3d4/` |
...
3. 작성자  POST /obituaries
     ...
     3-2. S3      {id}/index.html 업로드
     3-3. Sheets  1행 append
